...
export default function OBGYNPatientDirectory() {
                        ...
                        ? {
                            ...
                            patient_referrals: [
                                ...(p.patient_referrals ?? []),
                                {
                                    ...
                                    referring_doctor_specialty: data[0].referring_doctor_specialty,
                                },
                            ],
                        }
                        : p
  ...
  `)
    ...
    return (
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                                        <div className="relative w-full sm:w-[300px]">
                                            ...
                                            <Input
                                                ...
                                                className="pl-10 border border-gray-300  text-[#6B7280] border border-[#ECEEF0] bg-[#FFFFFF] hover:shadow-sm"
                                                placeholder="Search..."
                                            />
                                        </div>
                                        ...
                                        >
                                            <SelectTrigger className="w-[140px] text-[#6B7280] border border-[#ECEEF0] bg-[#FFFFFF] cursor-pointer hover:shadow-sm w-[106px]">
                                                        ...
                                                        paginatedPatientDirectory.map((patient) => {
                                                            ...
                                                            return (
                                                                <TableRow key={patient.id}>
                                                                    ...
                                                                    <TableCell>
                                                                        <button
                                                                            onClick={() => navigate(`/patientdirectory/patientprofile/${patient.id}`)}
                                                                    ...
                                                                    <TableCell>
                                                                        <Select
                                                                            value={patient.risk_level ?? "Low"}
                                                                            onValueChange={async (newRisk) => {
                                                                                console.log("👉 Selected risk level:", newRisk);

                                                                                // Optimistic UI update
                                                                                setPatients((prev) =>
                                                                                    prev.map((p) =>
                                                                                        p.id === patient.id ? { ...p, risk_level: newRisk } : p
                                                                                    )
                                                                                );
                                                                                ...
                                                                                console.log("Updating risk level to:", newRisk);
        ...
        text-xs h-[20px] min-w-[70px] px-2 
