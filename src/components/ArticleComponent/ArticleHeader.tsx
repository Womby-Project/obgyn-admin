      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <div className="flex items-center w-full md:w-auto gap-3">
          ...
          <button className="flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2 px-4 hover:bg-gray-50 transition text-sm text-gray-600 font-medium">
            <span>Sort</span>
            <Icon icon="fluent:arrow-sort-20-filled" className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full md:w-auto px-5 py-2.5 border-2 border-[#E46B64] text-[#E46B64] rounded-lg hover:bg-[#E46B64]/10 transition-colors font-semibold text-sm shadow-sm"
          >
