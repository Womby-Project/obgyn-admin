...
export default function SecretarySecurityPage() {
  ...
  // Fetch secretary user + 2FA setting
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        toast.error(err.message || "Failed to fetch secretary data")
      }
    }
    fetchUser()
  }, [])
  ...
  // Toggle 2FA for secretary_users
